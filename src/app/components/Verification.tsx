...
import { resendotp, verification } from "../utils/requests";
      ...
      >
        ...
        <p className="text-sm text-center mt-4 text-gray-600">
          ...
          <button
            ...
            className={`cursor-pointer text-blue-500 font-medium hover:underline transition ${
              isResendLoading || cooldownTime > 0
          ...
          >
            {isResendLoading ? (
              <>
                <svg
                  className="animate-spin -ml-1 mr-1 h-4 w-4 inline-block"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
